...
public class ShooterCalculator {
    ...
    public double calculateFlywheelRPMFromCurrentPose()
    {
    ...
    public double calculateRestFlywheelSpeedFromCurrentPose()
    {
        ...
        double rpm = (frc.robot.constants.ShooterConstants.IDLE_RPM_DIST/commandSwerveDrivetrain.getDistanceToHub())*frc.robot.constants.ShooterConstants.IDLE_RPM;
