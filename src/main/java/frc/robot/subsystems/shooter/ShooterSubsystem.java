...
public class ShooterSubsystem extends Shooter {
    ...
    public ShooterSubsystem(CommandSwerveDrivetrain commandSwerveDrivetrain) {
        ...
        configShooter1.closedLoop.feedbackSensor(FeedbackSensor.kPrimaryEncoder).pid(0.11, 0.0, 0.0);
        ...
        configShooter2.closedLoop.feedbackSensor(FeedbackSensor.kPrimaryEncoder).pid(0.11, 0.0, 0.0);
        ...
        configShooter3.closedLoop.feedbackSensor(FeedbackSensor.kPrimaryEncoder).pid(0.11, 0.0, 0.0);
        ...
        configShooter4.closedLoop.feedbackSensor(FeedbackSensor.kPrimaryEncoder).pid(0.11, 0.0, 0.0);
        ...
        configShooter5.closedLoop.feedbackSensor(FeedbackSensor.kPrimaryEncoder).pid(0.11, 0.0, 0.0);
        ...
        configShooter6.closedLoop.feedbackSensor(FeedbackSensor.kPrimaryEncoder).pid(0.11, 0.0, 0.0);
...
public void stateMachine() {
    ...
    public double getRPMFlywheel() { return getVelocityShooter1() / ShooterConstants.flywheelGearRatio; }
